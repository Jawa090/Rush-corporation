        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative py-3 md:py-6 flex justify-center md:justify-end">
              <img src="/company.png" alt="Rush offices" className="w-[92%] sm:w-[85%] md:w-[70%] h-auto" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
            <div className="relative py-2 md:py-4 flex justify-center md:justify-start">
              <img src="/people.png" alt="Rush people" className="w-[92%] sm:w-[85%] md:w-[70%] h-auto" />
            </div>
            <div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
            ...
            <div className="relative py-2 md:py-4 flex justify-center md:justify-end">
              <img src="/brands.png" alt="Rush brands" className="w-[92%] sm:w-[85%] md:w-[70%] h-auto" />
            </div>
          </div>
        </div>
      </section>
